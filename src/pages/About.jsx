      ...
      const teamMembers = [
        {
          name: "Dr. Ana Sousa",
          role: "CEO & Fundadora",
          bio: "Engenheira visionária com paixão por tecnologia assistiva e mais de 15 anos de experiência.",
          image: "Retrato profissional de uma mulher sorrindo em um escritório moderno"
        },
        {
          name: "Marcos Varela",
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
                  {teamMembers.map((member, index) => (
                    <motion.div 
                      ...
                      className="text-center"
                    >
                      <img  class="mx-auto h-40 w-40 rounded-full object-cover" src="#" alt={member.name} src="https://images.unsplash.com/photo-1644424235476-295f24d503d9" />
