                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                  ...
                  >
                    <div className="animate-float">
                      <img alt="Bengala inteligente Caminho Seguro flutuando com um brilho tecnológico" class="w-full max-w-sm md:max-w-md rounded-lg shadow-2xl" src="https://res.cloudinary.com/djjkgp7yl/image/upload/v1758118543/bengala02_nsipyf.png" />
                    </div>
                  </motion.div>
                </div>
              </div>
